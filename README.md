...
This solves three use cases:

1. publishing to [crates.io], or other alternate crate registries,
2. updating `Cargo.toml` versions and
3. compiling release binaries
